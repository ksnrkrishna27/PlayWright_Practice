...
test("Ordering item", async () => {
  ...
  const download_locator: Locator = await page_after_login.locator(
    '//*[@id="column-right"]/div/a[7]'
  );
  ...
  await page_after_login.screenshot({
    path: "./Screenshots/download_page.png",
  });
